...
function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen bg-[#050505] overflow-hidden flex items-center">
      ...
      {/* استخدام نفس الحاوية (container) ليتناسب مع الـ Navbar */}
      <div className="container mx-auto px-6 md:px-10 z-10">
        
        {/* flex-row يجعل الصورة (التي هي أولاً في الكود) على اليسار والنص على اليمين */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          
          {/* قسم الصورة - قادم من اليسار */}
          <motion.div 
